...
run_script='exp_run_mythril_v0.23.22_bin_900s.sh'

con_work_dir='/home/mythril/'


sif_dir=${base_path}
sif_name='xxx_mythril_v0.23.22.sif' # replace with the actual sif image name
...
echo 'start job'$i
 sbatch  -p normal -n 1 -N 1 -t 3:00:00 -J j$((i+1))m$id J30Container1.sh  $((i*30))  ${group_name_prefix} ${run_script} ${start_container_script} ${base_path} ${con_work_dir} ${sif_name} ${times_id} &
