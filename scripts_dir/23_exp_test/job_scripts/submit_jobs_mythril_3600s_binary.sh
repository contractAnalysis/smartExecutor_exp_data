...
echo 'start job'$i
 sbatch  -p normal -n 1 -N 1 -t 4:20:00 -J job_$((i+1))_mythril J30Container.sh  $((i*30))  ${group_name_prefix} ${run_script} ${start_container_script} ${base_path} ${con_work_dir} ${sif_name} &
