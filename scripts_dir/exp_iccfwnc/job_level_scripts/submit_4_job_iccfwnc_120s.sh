...
echo sbatch  -p  normal -n 1 -N 1 -t 6:00:00 -J job_$((i+1))_iccfwnc J06Container_maverick2.sh  $((i*6))  ${group_name_prefix} ${run_script} ${job_1_container_script} ${base_path} ${con_work_dir} ${sif_name}
