...
echo sbatch  -p  normal -n 1 -N 1 -t 3:00:00 -J job_$((i+1))_iccfwnc J06Container_maverick2.sh  $((i*6))  ${group_name_prefix} ${run_script} ${job_1_container_script} ${base_path} ${con_work_dir} ${sif_name} >>sss.txt 2>&1
...
i=13
 echo sbatch  -p  normal -n 1 -N 1 -t 3:00:00 -J job_$((i+1))_iccfwnc J01Container_maverick2.sh  $((i*1))  ${group_name_prefix} ${run_script} ${job_1_container_script} ${base_path} ${con_work_dir} ${sif_name} >>sss.txt 2>&1
