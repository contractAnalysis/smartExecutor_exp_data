...
base_path='/scratch/06227/'+Constants.user+'/exp_phase2/test_phase2_120_contracts/smartExecutor_data/' # the path where all data required for the experiments are placed
