...
contract Committee is ICommittee, ContractRegistryAccessor, WithClaimableFunctionalOwnership, Lockable {
	...
	uint constant MAX_COMMITTEE_ARRAY_SIZE = 32; 
	...
	function setMaxTimeBetweenRewardAssignments(uint32 maxTimeBetweenRewardAssignments) external onlyFunctionalOwner  {
	...
	function setMaxCommittee(uint8 maxCommitteeSize) external onlyFunctionalOwner  {
