...
contract Nest_3_VoteFactory {
    ...
    uint256 _limitTime = 7 days;                                    
    uint256 _NNLimitTime = 1 days;                                  
    uint256 _circulationProportion = 51;                            
    uint256 _NNUsedCreate = 10;                                     
    uint256 _NNCreateLimit = 100;                                   
    uint256 _emergencyTime = 0;                                     
    uint256 _emergencyTimeLimit = 3 days;                           
    uint256 _emergencyNNAmount = 1000;                              
    ERC20 _NNToken;                                                 
    ERC20 _nestToken;                                               
    mapping(string => address) _contractAddress;                    
    mapping(address => bool) _modifyAuthority;                      
    mapping(address => address) _myVote;                            
    mapping(address => uint256) _emergencyPerson;                   
    mapping(address => bool) _contractData;                         
    bool _stateOfEmergency = false;                                 
...
contract Nest_3_VoteContract {
    ...
    Nest_3_Implement _implementContract;                
    Nest_3_TokenSave _tokenSave;                        
    Nest_3_VoteFactory _voteFactory;                    
    Nest_3_TokenAbonus _tokenAbonus;                    
    ERC20 _nestToken;                                   
    ERC20 _NNToken;                                     
    address _miningSave;                                
    ...
    uint256 _destroyedNest;                             
    uint256 _NNLimitTime;                               
    uint256 _NNCreateLimit;                             
    uint256 _abonusTimes;                               
    uint256 _allNNAmount;                               
    bool _effective = false;                            
    bool _nestVote = false;                             
    bool _isChange = false;                             
    bool _stateOfEmergency;                             
    mapping(address => uint256) _personalAmount;        
    mapping(address => uint256) _personalNNAmount;      
