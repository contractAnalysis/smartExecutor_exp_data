    ...
    Ownable
{
    ...
    address payable public DGXContract = 0xBB246ee3FA95b88B3B55A796346313738c6E0150; 
    address payable public DGXTokenStorage = 0xC672EC9CF3Be7Ad06Be4C5650812aEc23BBfB7E1; 
    string constant name = "Bullionix";
    string constant title = "Bullionix"; 
    string constant symbol = "BLX"; 
    ...
    function _checkBalance() internal view returns (uint256) {
        uint256 tempBalance = dgxToken.balanceOf(address(this)); 
        require(tempBalance > 0, "Revert: Balance is 0!"); 
        return tempBalance; 
    }
    function _checkAllowance(address sender, uint256 amountNeeded)
        ...
        returns (bool)
    {
        uint256 tempBalance = dgxToken.allowance(sender, address(this)); 
        require(tempBalance >= amountNeeded, "Revert: Balance is 0!"); 
        return true; 
    }
        ...
        returns (string memory _URL)
    {
        ...
        return string(abi.encodePacked("https://app.bullionix.io/metadata/", uri)); 
    }
