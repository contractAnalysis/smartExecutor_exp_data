...
contract FeeTypes {
    ...
    bytes32 internal constant FOREIGN_FEE = 0xdeb7f3adca07d6d1f708c1774389db532a2b2f18fd05a62b957e4089f4696ed5; 
}
...
contract RewardableBridge is Ownable, FeeTypes {
    ...
    bytes4 internal constant GET_HOME_FEE = 0x94da17cd; 
    bytes4 internal constant GET_FOREIGN_FEE = 0xffd66196; 
    bytes4 internal constant GET_FEE_MANAGER_MODE = 0xf2ba9561; 
    bytes4 internal constant SET_HOME_FEE = 0x34a9e148; 
    bytes4 internal constant SET_FOREIGN_FEE = 0x286c4066; 
    bytes4 internal constant CALCULATE_FEE = 0x9862f26f; 
    bytes4 internal constant DISTRIBUTE_FEE_FROM_SIGNATURES = 0x59d78464; 
    bytes4 internal constant DISTRIBUTE_FEE_FROM_AFFIRMATION = 0x054d46ec; 
...
contract BaseOverdrawManagement is EternalStorage {
    ...
    bytes32 internal constant OUT_OF_LIMIT_AMOUNT = 0x145286dc85799b6fb9fe322391ba2d95683077b2adf34dd576dedc437e537ba7; 
    ...
    RewardableHomeBridgeErcToErc
{
    ...
    function _initialize(
        ...
        require(_foreignDailyLimitForeignMaxPerTxArray[1] < _foreignDailyLimitForeignMaxPerTxArray[0]); 
