...
contract EDANSale is Owned{
    ...
    uint256 public constant totalSupply         = (99 ** 9) * (10 ** 18); 
    ...
    uint256 constant edanPerEth = 3500;  
    uint256 constant edanPerEthEarlyStage = edanPerEth + edanPerEth * 15 / 100;  
    ...
    uint public constant startTime = 1595678400; 
    uint public constant endTime = 1598356800;   
    uint public constant earlyStageLasts = 13 days; 
