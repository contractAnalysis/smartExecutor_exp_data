...
contract glare is Owned {
  ...
  IERC20 public glaretoken; 

  
  uint256 public scalefactor;         
  uint256 public buyMinimum;          
  uint256 public sellMinimum;         
  uint256 public buyTax;              
  uint256 public referRate;           
  uint256 public referRateMasternode; 

  mapping(address => bool) public masternode; 
  mapping(address => address) public referBook; 

  
  uint256 public tokenTime; 
  uint256 public cdGLXMin;
  uint256 public cdDurrationMax;
  uint256 public earlyPenalty; 
  mapping(address => accountCDStruct[]) public accountCD; 
