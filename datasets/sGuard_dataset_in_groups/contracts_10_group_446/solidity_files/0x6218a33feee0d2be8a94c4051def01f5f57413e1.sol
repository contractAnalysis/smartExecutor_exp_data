...
contract DyDAIImpl {
    ...
    function buyTokens(uint256 DAIAmount) external   
    {
        ...
        require(ERC20Mintable(address(token())).mint(sender, tokens),"Minting failed"); 
    }
    ...
    function sellTokens(uint256 tokenAmount) external 
    {
        ...
        uint256 initialDAIAmount=(tokenAmount.mul(_rate)).div(10**18);
        operate(address(this),initialDAIAmount,false);
        uint256 finalDAIAmount=(initialDAIAmount.div(1000)).mul(995);
