...
contract LoanProposalsModule is Module, ILoanProposalsModule {
    ...
    uint256 public constant COLLATERAL_TO_DEBT_RATIO = COLLATERAL_TO_DEBT_RATIO_MULTIPLIER * 3 / 2; 
    ...
    struct DebtProposal {
        ...
        mapping(address => DebtPledge) pledges;    
        address[] supporters;       
        uint256 lCovered;           
        uint256 pCollected;         
        uint256 created;            
    ...
    mapping(address=>uint256) public openProposals;         
