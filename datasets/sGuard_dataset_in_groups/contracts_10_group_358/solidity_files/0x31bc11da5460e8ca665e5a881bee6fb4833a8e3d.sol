...
contract TribeProducts is ERC721Enumerable , Ownable{
    ...
    mapping(uint256 => string) public tokenProduct; 
    ...
    function createProduct(
        ...
        require(products[_name].owner == address(0x0)); 
    ...
    function buyProduct(string memory _name) public payable returns (bool) {
        ...
        require(p.owner != address(0x0), "product not exist"); 
        require(p.price <= msg.value, "not enough eth"); 
