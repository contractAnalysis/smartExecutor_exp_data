...
{ 
    ...
    uint public _totalsupply = 7777777777 * (uint256(10) ** decimals); 
    ...
    {
        owner = msg.sender; 
        ceo = 0x16e491fd24d4640e27299F8b599CfEDF635Cd063; 

        address teamwall1 = 0xBaa11617F37de9bf2a66E3CC4a99203796350c00; 
        address teamwall2 = 0x9326Ee7DF7F686e2b018c246fEc0CFd717702e99; 
      

        balances[owner] = 1111111111 * (uint256(10) ** decimals); 
        balances[address(this)] = 3333333333 * (uint256(10) ** decimals); 
        
        balances[teamwall1] = 1111111111 * (uint256(10) ** decimals); 
        balances[teamwall2] = 1111111111 * (uint256(10) ** decimals); 
        balances[ceo] = 1111111111 * (uint256(10) ** decimals); 
    ...
    function () public payable 
    {
        ...
        uint256 tokPrice = ethCent.mul(1); 
